...
export function ThemeButton(props: ThemeButtonProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-full dark:text-yellow-600 text-blue-600 w-6 h-6 flex items-center justify-center transition-colors">
        {Icon('w-4 h-4')}
      </div>

      <div className="hidden flex-1 lg:flex items-center justify-end pr-2">
